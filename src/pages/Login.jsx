                ...
                <div className="bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl p-3 sm:p-5 border border-white/20 transform transition-all duration-300">
                    <div className="mb-5 text-center">
                        ...
                        <div className="flex items-center justify-center gap-1.5 mt-3 bg-gray-100 p-1 rounded-lg">
                            <button
                                ...
                                className={`flex-1 flex items-center justify-center gap-1 px-2 py-1.5 rounded-lg text-sm font-medium transition-all ${loginMethod === 'email'
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <div className="relative group">
                                <input
                                    ...
                                    className={`w-full px-3 py-2.5 pl-9 border-2 rounded-xl outline-none transition-all duration-300 text-base ${focusedField === 'email'
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`w-full py-2.5 px-4 rounded-xl font-medium text-lg transition-all transform hover:scale-[1.01] active:scale-[0.99] ${loading
                    ...
                    <div className="mt-5 pt-4 border-t-2 border-gray-100">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <Link
                                ...
                                className="group flex items-center justify-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 text-blue-700 rounded-lg transition-all font-medium text-sm"
                            >
                            ...
                            <Link
                                ...
                                className="group flex items-center justify-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-purple-50 to-purple-100 hover:from-purple-100 hover:to-purple-200 text-purple-700 rounded-lg transition-all font-medium text-sm"
                            >
