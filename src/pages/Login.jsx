...
const Login = () => {
    ...
    const carouselMessages = [
        { icon: FaHeartbeat, text: "Digital Health", color: "from-blue-300 to-cyan-300" },
        { icon: FaUserShield, text: "Enhance Patient Safety", color: "from-blue-200 to-blue-300" },
        { icon: FaCheckCircle, text: "Optimize Medicines Use", color: "from-cyan-200 to-blue-200" }
    ];
                ...
                setError(
                    <div className="flex flex-col gap-3">
                        ...
                        <button
                            ...
                            className="bg-blue-400 text-white text-xs font-bold py-2 px-4 rounded-lg hover:bg-blue-500 transition w-fit mt-2"
                        >
                ...
                setError(
                    <div className="flex flex-col gap-3">
                        ...
                        <button
                            ...
                            className="bg-blue-400 text-white text-xs font-bold py-2 px-4 rounded-lg hover:bg-blue-500 transition w-fit"
                        >
                            Resend Verification Email
                        </button>
                    </div>
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-100 via-blue-50 to-gray-100 flex items-start justify-center p-1 sm:p-3 relative overflow-auto">
            ...
            <div className="absolute inset-0 overflow-hidden hidden md:block">
                ...
                <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gray-200 rounded-full opacity-30 animate-pulse delay-1000"></div>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-blue-200 to-gray-200 rounded-full opacity-20 animate-ping"></div>

                {/* Floating medical icons */}
                <FaHeartbeat className="absolute top-20 left-20 text-blue-300 opacity-20 text-6xl animate-bounce" />
                <FaUserShield className="absolute bottom-20 right-20 text-blue-300 opacity-20 text-6xl animate-bounce delay-700" />
                <FaUserMd className="absolute top-40 right-40 text-blue-300 opacity-20 text-6xl animate-bounce delay-300" />
            </div>
            ...
            <div className="w-full max-w-md mx-auto relative z-10 px-4 sm:px-6 py-2 sm:py-4">
                ...
                <div className="text-center mb-4 transform hover:scale-105 transition-transform duration-300">
                    <div className="relative inline-block">
                        <div className="absolute inset-0 bg-blue-200 rounded-xl blur-xl opacity-50 animate-pulse"></div>
                        <div className="relative flex items-center justify-center w-14 h-14 bg-gradient-to-r from-blue-300 to-blue-400 rounded-xl mb-2 mx-auto shadow-2xl">
                            <FaUserMd className="text-white text-xl animate-pulse" />
                        </div>
                    </div>
                    <h1 className="text-3xl font-bold text-blue-800 mb-1 tracking-tight">Addis Med</h1>
                </div>

                {/* Login Card - Optimized for mobile */}
                <div className="bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl p-3 sm:p-5 border border-blue-200/50 transform transition-all duration-300">
                    ...
                    {error && (
                        <div className="mb-4 p-3 bg-blue-50 border-l-4 border-blue-400 rounded-r-xl animate-shake">
                            <div className="flex items-start gap-2">
                                <FaExclamationTriangle className="text-blue-500 mt-0.5 flex-shrink-0 text-xs animate-pulse" />
                                <div className="flex-1 min-w-0">
                                    <div className="text-blue-800 font-bold text-xs mb-0.5 uppercase tracking-wider">Error</div>
                                    <div className="text-blue-600 text-xs leading-relaxed">{error}</div>
                                </div>
                            </div>
                        </div>
                    )}
                    ...
                    <div>
                        <div className="flex justify-center">
                            <div className="relative group w-full">
                                ...
                                />
                                {loginMethod === 'email' ? (
                                    <FaEnvelope className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-colors duration-300 text-sm ${focusedField === 'email' ? 'text-blue-400' : 'text-gray-400'}`} />
                                ) : (
                                    <FaIdCard className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-colors duration-300 text-sm ${focusedField === 'email' ? 'text-blue-400' : 'text-gray-400'}`} />
                                )}
                                {loginMethod === 'email' && isEmailValid && formData.email && (
                                    <FaCheckCircle className="absolute right-3 top-1/2 transform -translate-y-1/2 text-blue-400 text-sm animate-scale-in" />
                                )}
                        ...
                        <div>
                            <div className="flex justify-center">
                                <div className="relative group w-full">
                                    <input
                                        ...
                                        disabled={loading}
                                    />
                                    <FaLock className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-colors duration-300 text-sm ${focusedField === 'password' ? 'text-blue-400' : 'text-gray-400'}`} />
                                    <button
                                        type="button"
                            ...
                            {formData.password && (
                                <div className="mt-1.5 animate-slide-down">
                                    ...
                                    <p className={`text-[10px] mt-1 font-medium text-center ${passwordStrength === 1 ? 'text-blue-400' :
                      ...
                      <div className="flex justify-center">
                        <button
                            ...
                            className={`w-full py-2.5 px-4 rounded-xl font-bold text-lg transition-all transform hover:scale-[1.01] active:scale-[0.99] ${loading
                                ...
                                : 'bg-gradient-to-r from-blue-400 to-blue-500 hover:from-blue-500 hover:to-blue-600 text-white shadow-xl hover:shadow-2xl'
                            }`}
                        >
                            {loading ? (
                    ...
                    {process.env.NODE_ENV === 'development' && (
                        <div className="mt-4 p-3 bg-gradient-to-r from-blue-50 to-gray-50 rounded-xl border border-blue-200">
                            ...
                            <div className="grid grid-cols-3 gap-1.5">
                                <button
                                    ...
                                    className="px-2 py-1.5 text-[10px] bg-gradient-to-r from-blue-400 to-blue-500 hover:from-blue-500 hover:to-blue-600 text-white rounded-lg transition-all transform hover:scale-105 active:scale-95 font-medium"
                                >
                                    Admin
                                </button>
                                <button
                                    onClick={() => testLogin('test@example.com', 'password123')}
                                    className="px-2 py-1.5 text-[10px] bg-gradient-to-r from-blue-300 to-blue-400 hover:from-blue-400 hover:to-blue-500 text-white rounded-lg transition-all transform hover:scale-105 active:scale-95 font-medium"
                                >
                                    Test User
                                </button>
                                <button
                                    onClick={() => testLogin('HCC-K3M9X2-8A4F6B', 'healthcare123')}
                                    className="px-2 py-1.5 text-[10px] bg-gradient-to-r from-gray-400 to-gray-500 hover:from-gray-500 hover:to-gray-600 text-white rounded-lg transition-all transform hover:scale-105 active:scale-95 font-medium"
                                >
                                    Healthcare
                                </button>
                            </div>
                    ...
                    <div className="mt-5 pt-4 border-t-2 border-gray-100">
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            ...
                            <Link
                                ...
                                className="group flex items-center justify-center gap-1.5 px-3 py-2.5 bg-gradient-to-r from-gray-50 to-gray-100 hover:from-gray-100 hover:to-gray-200 text-gray-700 rounded-lg transition-all font-bold text-lg"
                            >
                                Organization
                            </Link>
                        </div>
                    ...
                    <div className="mt-4 text-center">
                        <p className="text-[10px] text-gray-500">
                            Having trouble?{' '}
                            <Link to="/contact-support" className="text-blue-400 hover:text-blue-600 underline font-medium transition-all hover:no-underline">
                                Contact Support
                            </Link>
                        </p>
                    </div>
                    ...
                    <div className="px-2 sm:px-3 py-2 sm:py-3 min-w-[100px] sm:min-w-[150px] space-y-2 sm:space-y-3">
                        ...
                        <div className="border border-transparent rounded-xl p-2 sm:p-3">
                            <div className="flex items-start gap-1.5 sm:gap-2">
                                <div className="flex-shrink-0 mt-0.5">
                                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-blue-300 to-blue-400 rounded-full flex items-center justify-center">
                                        <FaInfoCircle className="text-white text-[8px] sm:text-xs" />
                                    </div>
                                </div>
                                <div className="text-left">
                                    <p className="text-[8px] sm:text-[10px] text-blue-800 leading-tight sm:leading-relaxed font-medium">
                        ...
                        <div className="flex items-center gap-2 sm:gap-4 flex-wrap">
                            <div className="flex items-center gap-1 sm:gap-2">
                                ...
                                <span className="text-[8px] sm:text-xs text-blue-800">
                                    <span className="text-blue-800 ml-0.5 sm:ml-1 font-mono text-[10px] sm:text-[14px]">Addis Ababa, Ethiopia</span>
                                </span>
                            </div>
                            ...
                            <div className="flex items-center gap-1 sm:gap-2">
                                <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-blue-400 rounded-full"></div>
                                <span className="text-[8px] sm:text-xs text-blue-800">
                                    <span className="text-blue-800 ml-0.5 sm:ml-1 font-mono text-[10px] sm:text-[14px]">pharmcare2001@yahoo.com</span>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="px-2 sm:px-4 py-2 sm:py-3 min-w-[100px] sm:min-w-[150px] space-y-3 sm:space-y-6">
                                    ...
                                    {carouselMessages.map((msg, index) => {
                                        ...
                                        return (
                                            <div key={index} className="h-8 flex items-center justify-center gap-1.5">
                                                ...
                                                <p className="text-blue-800 text-[8px] sm:text-sm font-bold italic">{msg.text}</p>
                                            </div>
                                        );
                                    })}
                                </div>
                        ...
                        <div className="flex items-center gap-2 sm:gap-4 flex-wrap justify-end pt-0.5 sm:pt-1">
                            <div className="flex items-center gap-1 sm:gap-2">
                                <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-blue-400 rounded-full"></div>
                                <span className="text-[8px] sm:text-xs text-blue-800">
                                    <span className="text-blue-800 ml-0.5 sm:ml-1 font-mono text-[10px] sm:text-[14px]">+251919519512</span>
                                </span>
                            </div>
                            ...
                            <div className="flex items-center gap-1 sm:gap-2">
                                <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-blue-400 rounded-full"></div>
                                <span className="text-[8px] sm:text-xs text-blue-800">
                                    <span className="text-blue-800 ml-0.5 sm:ml-1 font-mono text-[10px] sm:text-[14px]">tiktok.com/@addis.med</span>
                                </span>
                            </div>
                        </div>
                    </div>
